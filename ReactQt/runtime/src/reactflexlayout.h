...
enum FlexMeasureMode { MeasureMode_Undefined = 0, MeasureMode_Exactly, MeasureMode_AtMost };

typedef std::pair<double, double> flex_dimensions;
typedef std::function<flex_dimensions(
    double width, FlexMeasureMode widthMode, double height, FlexMeasureMode heightMode)>
    measure_function;
