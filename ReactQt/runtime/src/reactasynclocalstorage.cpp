...
void ReactAsyncLocalStorage::multiGet(const QList<QString>& keys,
...
void ReactAsyncLocalStorage::multiSet(const QList<QList<QString>>& kvPairs,
                                      const ReactModuleInterface::ListArgumentBlock& callback) {
    if (m_settings == nullptr) {
        callback(m_bridge, QVariantList{QVariantList{makeError("Could not open storage file")}, QVariant()});
        return;
...
void ReactAsyncLocalStorage::multiRemove(const QList<QString>& keys,
                                         const ReactModuleInterface::ListArgumentBlock& callback) {
    if (m_settings == nullptr) {
        callback(m_bridge, QVariantList{QVariantList{makeError("Could not open storage file")}, QVariant()});
        return;
...
void ReactAsyncLocalStorage::clear(const ReactModuleInterface::ListArgumentBlock& callback) {
    if (m_settings == nullptr) {
        callback(m_bridge, QVariantList{QVariantList{makeError("Could not open storage file")}, QVariant()});
        return;
    }
...
void ReactAsyncLocalStorage::getAllKeys(const ReactModuleInterface::ListArgumentBlock& callback) {
    if (m_settings == nullptr) {
        callback(m_bridge, QVariantList{QVariantList{makeError("Could not open storage file")}, QVariant()});
        return;
    }
...
ReactAsyncLocalStorage::ReactAsyncLocalStorage(QObject* parent)
    : QObject(parent), m_bridge(nullptr), m_settings(nullptr) {}
