...
struct RegisterClass {
    RegisterClass() {
        qRegisterMetaType<ReactNetExecutor*>();
    }
} registerClass;
}
...
ReactNetExecutor::ReactNetExecutor(QObject* parent) : ReactExecutor(parent), d_ptr(new ReactNetExecutorPrivate) {
...
void ReactNetExecutor::executeJSCall(const QString& method,
...
void ReactNetExecutor::processRequest(const QByteArray& request, const ReactExecutor::ExecuteCallback& callback) {
    Q_D(ReactNetExecutor);
