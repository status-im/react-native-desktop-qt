...
{
  Q_OBJECT
  Q_PROPERTY(QString p_backfaceVisibility READ backfaceVisibility WRITE setBackfaceVisibility NOTIFY backfaceVisibilityChanged)
  ...
  Q_PROPERTY(double p_borderTopLeftRadius READ borderTopLeftRadius WRITE setBorderTopLeftRadius NOTIFY borderTopLeftRadiusChanged)
  Q_PROPERTY(double p_borderTopRightRadius READ borderTopRightRadius WRITE setBorderTopRightRadius NOTIFY borderTopRightRadiusChanged)
  Q_PROPERTY(double p_borderBottomLeftRadius READ borderBottomLeftRadius WRITE setBorderBottomLeftRadius NOTIFY borderBottomLeftRadiusChanged)
  Q_PROPERTY(double p_borderBottomRightRadius READ borderBottomRightRadius WRITE setBorderBottomRightRadius NOTIFY borderBottomRightRadiusChanged)
  ...
  Q_PROPERTY(double p_borderBottomWidth READ borderBottomWidth WRITE setBorderBottomWidth NOTIFY borderBottomWidthChanged)
