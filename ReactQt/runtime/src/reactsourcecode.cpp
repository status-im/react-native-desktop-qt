...
void ReactSourceCode::getScriptText(const ReactModuleInterface::ListArgumentBlock& resolve,
...
ReactSourceCode::ReactSourceCode(QObject* parent) : QObject(parent), d_ptr(new ReactSourceCodePrivate) {}
